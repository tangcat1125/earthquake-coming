...
function autoRemoveBackground(imgElement, sensitivity = 45) {
    ...
    tempImg.onload = () => {
        try {
            ...
            const trIdx = (tempImg.width - 1) * 4;
            const bgR2 = data[trIdx];
            const bgG2 = data[trIdx + 1];
            const bgB2 = data[trIdx + 2];
            ...
            for (let i = 0; i < data.length; i += 4) {
                ...
                const dist1 = Math.sqrt((r - bgR) ** 2 + (g - bgG) ** 2 + (b - bgB) ** 2);
                const dist2 = Math.sqrt((r - bgR2) ** 2 + (g - bgG2) ** 2 + (b - bgB2) ** 2);

                if (dist1 < sensitivity || dist2 < sensitivity || (r < 30 && g < 30 && b < 30)) {
                    data[i + 3] = 0;
                }
            }
            ...
            console.log('Local canvas auto-bg removal fallback: ', e);
        }
    };
}
...
function drawStageCards(stageId) {
    ...
    return drawnHand.map(card => {
        ...
        return {
            ...
            desc: card.action,
            damage: damage,
            outcomeImage: isCorrect ? `assets/outcomes/act${stageId}_safe.png` : `assets/outcomes/act${stageId}_wrong.png`,
...
const ACTS_DATA = [
    {
        ...
        bgImage: "assets/scenes/act1_classroom.png",
        speakerName: "教導主任",
        speakerAvatar: "assets/avatars/avatar_dean.png",
        speakerEmotion: "【驚慌極限】",
    ...
    },
    {
        ...
        phaseName: "主震中期 (搖晃高峰)",
        bgImage: "assets/scenes/act2_lab.png",
        speakerName: "阿凱同學",
        speakerAvatar: "assets/avatars/avatar_student.png",
        speakerEmotion: "【極度恐慌】",
    ...
    },
    {
        ...
        bgImage: "assets/scenes/act3_stairwell.png",
        speakerName: "四年級阿凱",
        speakerAvatar: "assets/avatars/avatar_student.png",
        speakerEmotion: "【極度恐慌】",
    ...
    },
    {
        ...
        phaseName: "疏散半途無遮蔽危機",
        bgImage: "assets/scenes/act4_corridor.png",
        speakerName: "帶隊老師",
        speakerAvatar: "assets/avatars/avatar_dean.png",
        speakerEmotion: "【緊急戒備】",
    ...
    },
    {
        ...
        phaseName: "最後一哩回報危機",
        bgImage: "assets/scenes/act5_playground.png",
        speakerName: "指揮官（校長）",
        speakerAvatar: "assets/avatars/avatar_principal.png",
        speakerEmotion: "【嚴肅指揮】",
...
function renderScene() {
    ...
    autoRemoveBackground(elements.speakerAvatar, 45);
